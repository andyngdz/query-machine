...
var useQueryMachine = function (axios) {
    var _a = (0, react_1.useMachine)((0, states_1.requestMachine)()), state = _a[0], send = _a[1];
    ...
    return __assign(__assign({}, requests), { isIdle: isIdle, isRequest: isRequest, isSuccess: isSuccess, isFailure: isFailure, send: send, state: state });
};
